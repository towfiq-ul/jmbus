...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions on
this repository), and also applies when an individual is officially representing the community
in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainer via a private GitHub message, or by opening an issue asking for an alternative
private contact method. All complaints will be reviewed and investigated promptly and fairly.
...
https://www.contributor-covenant.org/version/2/1/code_of_conduct.html, used under
